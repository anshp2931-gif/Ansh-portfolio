...
const Hero = () => {
    ...
    React.useEffect(() => {
        ...
        }, 8000); // Sync with animation cycle
    ...
    return (
        <section className="min-h-screen flex items-center relative overflow-hidden px-4 md:px-12 lg:px-24">
            {/* Background Effects */}
            ...
            <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
                ...
                >
                    ...
                    <motion.div
                        variants={itemVariants}
                        className="relative min-h-[4rem] md:min-h-[5rem]"
                    >
                        <motion.span
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            className="text-4xl md:text-6xl font-black tracking-tight text-primary block mb-12"
                        >
                ...
                >
                    <div className="relative inline-block group">
                        <div className="w-64 h-64 md:w-96 md:h-96 rounded-full overflow-hidden glass p-1 glow-box relative z-10">
                            <img
                                src={profileImg}
                                alt="Ansh Patel"
                        ...
                        <div className="absolute -inset-4 bg-electric-cyan/20 rounded-full blur-2xl animate-pulse pointer-events-none" />
                        <div className="absolute -inset-2 border-2 border-electric-cyan/30 rounded-full animate-spin-slow pointer-events-none" />
                    </div>
                </motion.div>
            </div>
